"""
Django settings for django_food_truck project.
...
ROOT_URLCONF = 'django_food_truck.urls'
...
WSGI_APPLICATION = 'django_food_truck.wsgi.application'
...
# Best pratice to have a User model
